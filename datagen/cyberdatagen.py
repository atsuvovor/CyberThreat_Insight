...
class DataConfig:
    ...
    def __init__(self):
        ...
        #self.anomalous_data_file= "cybersecurity_dataset_for_google_drive_anomalous_data_v1.csv"
        #self.normal_data_file = "cybersecurity_dataset_for_google_drive_normal_data_v1.csv"
        #self.normal_and_anomalous_file = "cybersecurity_normal_and_anomalous_dataset_for_google_drive_v1.csv"

        #Google drive
        #self.google_drive_data_folder = "/content/drive/My Drive/Cybersecurity Data"

        #https://github.com/atsuvovor/CyberThreat_Insight/tree/main/datagen
        self.datagenerator_folder = "datagen"
        
        #self.normal_data_file_path_to_google_drive = os.path.join(self.google_drive_data_folder, "cybersecurity_dataset_for_google_drive_normal_data_v2.csv")
        self.normal_data_file_path = os.path.join(self.datagenerator_folder, "cybersecurity_dataset_normal_data.csv")
        
        #self.anomalous_data_file_path_to_google_drive = os.path.join(self.google_drive_data_folder, "cybersecurity_dataset_for_google_drive_anomalous_data_v2.csv")
        self.anomalous_data_file_path = os.path.join(self.datagenerator_folder, "cybersecurity_dataset_anomalous_data.csv")
        
        #self.file_path_to_normal_and_anomalous_google_drive = os.path.join(self.google_drive_data_folder, "normal_and_anomalous_cybersecurity_dataset_for_google_drive_kb2.csv")
        ...
        #self.key_threat_indicators_file_path_to_on_google_drive = os.path.join(self.google_drive_data_folder, "key_threat_indicators_df2.csv")
        self.key_threat_indicators_file_path = os.path.join(self.datagenerator_folder, "key_threat_indicators_df.csv")

        
        #self.scenarios_with_colors_file_path_to_on_google_drive = os.path.join(self.google_drive_data_folder, "scenarios_with_colors_df2.csv")
...
class DataSaver:
    ...
    def save_data_option(self, config):
        ...
        while True:
            ...
            if choice == 'yes':
                ...
                #shutil.copy(config.normal_data_file_path_to_google_drive, temp_dir)
                #shutil.copy(config.anomalous_data_file_path_to_google_drive, temp_dir)
                #shutil.copy(config.file_path_to_normal_and_anomalous_google_drive, temp_dir)
                #shutil.copy(config.key_threat_indicators_file_path_to_on_google_drive, temp_dir)
                #shutil.copy(config.scenarios_with_colors_file_path_to_on_google_drive, temp_dir)
    ...
    def save_the_data_to_CSV_to_google_drive(self, config, p_normal_issues_df, p_anomalous_issues_df, p_normal_and_anomalous_df, p_ktis_key_threat_indicators_df, p_scenarios_with_colors_df):
        ...
        """
        # Save each DataFrame to its specified Google Drive path
        #self.save_dataframe_to_google_drive(p_normal_issues_df, config.normal_data_file_path_to_google_drive)
        #self.save_dataframe_to_google_drive(p_anomalous_issues_df, config.anomalous_data_file_path_to_google_drive)
        #self.save_dataframe_to_google_drive(p_normal_and_anomalous_df, config.file_path_to_normal_and_anomalous_google_drive)
        #self.save_dataframe_to_google_drive(p_ktis_key_threat_indicators_df, config.key_threat_indicators_file_path_to_on_google_drive)
        #self.save_dataframe_to_google_drive(p_scenarios_with_colors_df, config.scenarios_with_colors_file_path_to_on_google_drive)
