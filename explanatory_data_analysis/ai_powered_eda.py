...
def build_llm_client():
    ...
    if hf_key and InferenceClient:
        try:
            ...
            print(f"⚠️ HuggingFace client init failed, falling back to local: {e}")
...
def load_data_ui(data_output, on_confirm_callback):
    ...
    def on_confirm(btn):
        box.close()
        with data_output:
            print(f"👉 Selected option: {choice_widget.label}")
...
def eda_main_pipeline():
    ...
    def after_choice(choice_value):
        # --- Instantiate agent ---
        with data_output:
            print("🤖 A> Initializing validator agent...\n")
        ...
        with data_output:
            ...
            if not agent_validator.validation_errors(report):
                ...
                print("🤖 A> Validation issues detected.")
                return
            print("🤖 A> ✅ Agent built successfully.\n")
            ...
            if not validation_errors:
                ...
                try:
                    ...
                    if "explaratory_data_analysis_pipeline" in globals():
                        ...
                        print("⚠️ Skipping EDA: 'explaratory_data_analysis_pipeline' is not defined.")
                        return None
                except Exception as e:
                    print(f"❌ Error running EDA pipeline: {e}")
                    return None
            else:
                print("⚠️ Validation issues detected, skipping EDA pipeline.")
                return None
